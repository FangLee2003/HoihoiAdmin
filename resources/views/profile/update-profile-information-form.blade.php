<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="experience" type="number" min="0" max="60" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="category" type="text" class="mt-1 block w-full" wire:model.defer="state.category"
